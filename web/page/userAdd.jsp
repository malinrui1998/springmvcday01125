...
<div class="main">
    ...
    <form id="form1" name="form1" method="post" action="<%=request.getContextPath()%>/mlr/userAdd.action">
        ...
        <div class="content">
            <table class="box">
                ...
                <tr>
                    ...
                    <td><input type="text" name="name" class="text" id="name" value=""> <font color="red">*</font><font
                            color="red" id="name_span"></font></td>
                </tr>
                <tr>
                    <td class="field">用户账号：</td>
                    <td><input type="text" name="username" class="text" id="loginName" value=""> <font
                ...
                <tr>
                    ...
                    <td><input type="password" name="rpassword" class="text" id="rpassword" value=""> <font color="red">*</font>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="birthDate" class="text" id="birthDate" value=""> <font
                            color="red">*</font><font color="red" id="birthDate_span"></font></td>
                </tr>
                <tr>
                    <td class="field">用户电话：</td>
                    <td><input type="text" name="phone" class="text" id="phone" value=""> <font
