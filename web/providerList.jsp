        ...
        <tr>
            <td>
                <form method="post" action="provider.do">
                    <input name="method" value="query" class="input-text" type="hidden"> 供应商名称：
                    <input name="proName" class="input-text" type="text" value="">&nbsp;&nbsp;&nbsp;&nbsp;
...
<div class="main">
    ...
    <div class="optitle clearfix">
        <em><input value="添加供应商" class="input-button" onclick="window.location='providerAdd.jsp'" type="button">
        </em>
    ...
    <div class="content">
        <table class="list">
            ...
            <tr>
                ...
                <td width="100">
                    <div class="STYLE1" align="center">联系电话</div>
                </td>
                <td width="100">
                    <div class="STYLE1" align="center">传真</div>
                </td>
                <td width="100">
                    <div class="STYLE1" align="center">操作时间</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td><span class="STYLE1"><a href="providerView.jsp" style="color:red"> 北京市粮油总公司</a>
						</span>
                </td>
