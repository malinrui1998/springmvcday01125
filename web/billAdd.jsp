...
<div class="main">
    ...
    <form id="form1" name="form1" method="post" action="/library/bookServlet?flag=register">
        ...
        <div class="content">
            <table class="box">
                ...
                <tr>
                    ...
                    <td><input type="text" name="productName" class="text" id="productName" value=""> <font color="red">*</font><font
                ...
                <tr>
                    ...
                    <td><input type="radio" name="payed" value="1">是
                        <input type="radio" name="payed" checked="" value="0">否
                    </td>
                </tr>
                </tbody>
            </table>
